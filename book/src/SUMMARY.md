...
- [Hello World](./user_guide/helloworld.md)

# Language Reference

- [Built-in Types](language_reference/builtin_types.md)
- [Variables](./language_reference/variables.md)
- [Operators](./language_reference/operators.md)
...
- [Generics](./language_reference/generics.md)
- [Error Handling](./language_reference/error_handling.md)
- [Namespaces](./language_reference/namespaces.md)
- [Standard Library](./language_reference/standard_library.md)
