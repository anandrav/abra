...
pub mod ffi {
    pub mod term {
        ...
        pub unsafe extern "C" fn flush(vm: *mut Vm) { unsafe {
            let ret: () = term::flush();
            ret.to_vm(vm);
        }}
    }
